...
include { comparem as comparem_heimdall } from '../modules/comparem.nf'
...
workflow asgard_functional_annotation{
    ...
    guaymas_gtdbtk = Channel.fromPath("results/asgard_assessment_results/gtdbtk_results/guaymas_gtdbtk.ar53.summary.tsv")
    public_gtdbtk = Channel.fromPath("results/asgard_assessment_results/gtdbtk_results/public_gtdbtk.ar53.summary.tsv")
